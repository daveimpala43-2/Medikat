    ...
    <div class="footer">
        <div class="cabeza">MEDIKAT
        <br> Soluciones medicas para cualquier problema xd
         </div>
        ...
        <div class="cont2">
            <div class="derecho">
              </div> <h7 class ="Redes-soli"> Redes Sociales </h7>
            <div class="derecho">
            </div>
            <div class="face">
        ...
        <div class="cont4">
          <div class="derecho">
          </div> <img class="img-fluid logo" src="img/Logo.png">
          </div>

        <div class="cont5">Derechos reservados a Medikat ®</div>
    </div>